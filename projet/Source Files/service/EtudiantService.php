...
class EtudiantService implements IDao
{
    ...
    public function create($o)
    {
        $query = "INSERT INTO Etudiant (`id`, `nom`, `prenom`, `ville`, `sexe`, `date_naissance`, `image`) "
            . "VALUES (NULL, '" . $o->getNom() . "', '" . $o->getPrenom() . "', '" . $o->getVille() . "', '" . $o->getSexe() . "', '" . $o->getDateNaissance() . "', '" . $o->getImage() . "');";
    ...
    public function update($o) {
        $query = "UPDATE `etudiant` SET `nom` = '" . $o->getNom() . "', `prenom` = '" . $o->getPrenom() . "', `ville` = '" . $o->getVille() . "', `sexe` = '" . $o->getSexe() . "', `date_naissance` = '" . $o->getDateNaissance() . "', `image` = '" . $o->getImage() . "' WHERE `etudiant`.`id` = " . $o->getId();
        $req = $this->connexion->getConnexion()->prepare($query);
        $req->execute() or die('Erreur SQL');
    }
